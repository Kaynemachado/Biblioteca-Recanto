...
<div class="menu">
 ...
 <div class="w3-bar w3-theme-l1 w3-left-align w3-large">
  ...
  <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="width:90px">
      <a href="lista_usuarios.php" class="w3-bar-item w3-button">Aluno</a>
  ...
  <div class="w3-dropdown-hover w3-hide-small">
    ...
    <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="width:300px">
      <a href="TCA_NewSite.php" class="w3-bar-item w3-button">Aluno</a>
