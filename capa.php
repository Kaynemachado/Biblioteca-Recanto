...
<head>
    <title>Biblioteca | Recanto do Saber</title>
    <meta charset="UTF-8">
...
um sistema empréstimos, renovações e consulta de exemplares no acervo escolar da escola citada! </p>
        </div> <div class="box-cell " style="margin-left:700px; margin-right:px; width:45%; margin-top:20px; ">
            <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
                <tr>
                    <td class="glyphicon glyphicon-map-marker w3-xlarge w3-centers"></td>
                    <td>AVENIDA NEREU RAMOS, 1455 PARQUE DAS AVENIDAS. 88960-000 Sombrio - SC</td>
                </tr>
                <tr>
                    <td class="glyphicon glyphicon-map-marker w3-xlarge w3-centers"></td>
                    <td> (48) 3533-5279</td>
                ...
                <tr>
                    <td class="glyphicon glyphicon-map-marker w3-xlarge w3-centers"></td>
                    <td>Código INEP: 42104904</td>
                </tr>
                <tr>
                    <td class="glyphicon glyphicon-map-marker w3-xlarge w3-centers"></td>
                    <td>Localização: Urbana</td>
                </tr>
                <tr>
                    <td class="glyphicon glyphicon-map-marker w3-xlarge w3-centers"></td>
                    <td>Etapas: Ensino Infantil, Ensino Fundamental</td>
                </tr>
                <tr>
                    <td class="glyphicon glyphicon-map-marker w3-xlarge w3-centers"></td>
                    <td>Modalidades: Ensino Regular</td>
                </tr>
            </table><br>
            <a href="http://cdn.novo.qedu.org.br/escola/42104904-e-e-b-mun-profa-nair-alves-bratti"
                class="w3-button w3-dark-grey">Saiba Mais  <i class="fa fa-arrow-right"></i></a>
        </div>
        </div>
        </div>
        <hr>
